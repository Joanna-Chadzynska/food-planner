...
const initialState: SchedulesState = {
	...
	schedule: {
		...
		weekNumber: 1,
		monday: [
			{ name: 'breakfast', recipeId: undefined },
			{ name: 'lunch', recipeId: undefined },
			{ name: 'soup', recipeId: undefined },
			{ name: 'dinner', recipeId: undefined },
			{ name: 'supper', recipeId: undefined },
		],
		tuesday: [
			{ name: 'breakfast', recipeId: undefined },
			{ name: 'lunch', recipeId: undefined },
